package com.xxx.mining.model.sp;
...
public class SharedConst {
    ...
    public static final String VALUE_COUNTY_CITY = "value_county_city";   //用户手机号城市
    ...
    public static final String IS_SETTING_NODE = "is_setting_node";   //是否设置过支付密码
