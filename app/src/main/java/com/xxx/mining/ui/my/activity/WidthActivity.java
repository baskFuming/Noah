...
public class WidthActivity extends BaseTitleActivity implements SwipeRefreshLayout.OnRefreshListener {

    public static void actionStartS(Activity activity) {
        Intent intent = new Intent(activity, WidthActivity.class);
    ...
    protected String initTitle() {
        return getString(R.string.my_with);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_width;
    }
